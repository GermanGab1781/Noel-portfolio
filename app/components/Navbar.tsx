...
export default function Navbar() {
  ...
  return (
    <nav className="flex flex-row fixed md:place-items-center md:place-content-between top-0 h-[6vh] w-full bg-gray-800 font-bold z-40">
      <Link className="mr-2 md:text-5xl text-4xl md:m-0 m-auto" href="/">🤝🏻</Link>
      <div className="flex md:flex-row flex-wrap text-center flex-col place-items-center md:w-auto w-screen md:gap-x-5 gap-x-0 text-white">
